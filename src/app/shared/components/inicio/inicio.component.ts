...
@Component({
  ...
  template: `
    ...
    <p>
      Herramienta que permite la administración de los créditos y la administración de la cartera de vivienda del Banco
      de la República.
      El Banco de la República cuenta con un Departamento de Operaciones Institucionales y Vivienda (DOIV) quien entre
      otras
